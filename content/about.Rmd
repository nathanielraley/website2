...
Besides, I like indoor activities best! I enjoy pestering each of my[^6] three[^7] cats,[^8] juggling,[^9] puzzling (sweeping mines,[^2] crossing words[^16]), [quizzing](https://utexas.campuslabs.com/engage/organization/QuizBowl), recreational [reading](https://www.goodreads.com/user/show/44370058-nathaniel) and mathematics (here's [a fun one I saw recently](https://www.janestreet.com/join-jane-street/open-positions/?utm_content=sierpinski)), eating spicy and or fermented[^3] things in accordance with lax (read: lapsed) veganism[^21] (basically, I eat cheese if it's free/going to waste/difficult to avoid). If I were a nonhuman animal, I have it on good authority that I would be an umbrella cockatoo[^4].

What else? I hate the residue left behind after peeling stickers off. I hate the film Amadeus (but then, I hate most films) and the TV show Game of Thrones (but then, I hate most TV). I hate when people use ugly em dashes  -- like these hideous things -- instead of their much prettier---and obviously correct---alternative. I guess I'm a cat person *and* a dog person (in that I like ~98% of the cats I've met but only about 10% of the dogs[^18])?
...
[^16]: <img src="crossword.jpg"> I sporadically worked the NYT puzzle in college, and on my 20th birthday my first name (24 across) and former middle name (76 across) were in it! It also features one of my favorite movies.
