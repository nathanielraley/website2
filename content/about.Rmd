...
<center><img height="200"  src="ndr_head.jpg" style="margin-right: 1%; margin-bottom: 0.5em;">
<img height="200" src="jubes_on_beach.png" style="margin-right: 1%; margin-bottom: 0.5em;"></center>
...
<center>![Three Ways I Usually Feel During Social Interactions](howIfeelwhen_meme1.png)</center>
...
Besides, I like indoor activities best! I enjoy pestering my[^6] three[^7] cats,[^8] juggling,[^9] puzzling (sweeping mines,[^2] crossing words[^16]), [quizzing](https://utexas.campuslabs.com/engage/organization/QuizBowl), recreational [reading](https://www.goodreads.com/user/show/44370058-nathaniel) and mathematics (here's [a fun one I saw recently](https://www.janestreet.com/join-jane-street/open-positions/?utm_content=sierpinski)), eating spicy and/or fermented[^3] things in accordance with lax (read: lapsed) veganism[^21] (basically, I eat cheese if it's free/going to waste/difficult to avoid). 


<center>![Same](lisa_myinterests.jpg)</center>

What else is there about me? If I were a nonhuman animal, I have it on good authority that I would be an umbrella cockatoo.[^4] I hate the residue left behind after peeling stickers off. I hate when copy editors use ugly em dashes  -- like these hideous things -- instead of their much prettier---and obviously correct---alternative. With few exceptions, I don't like watching movies or television shows:
I *hate* the film Amadeus, but I quite enjoyed Wall\*E. I think George R. R. Martin is a huge pervy hack, but I believe [Achewood](http://www.ohnorobot.com/random.pl?comic=636) should be short-listed for the Nobel Prize. I don't like "video games," but if I did, I would like real-time strategy games. I was fortunate to live through a fleeting golden age of music (late 2000s/early 2010s) when Girl Talk released *Feed The Animals* and *All Day*, Lady Gaga was everywhere unstoppable, the New Pornographers had at least 3 amazing albums, and Das Racist was still together. I guess I'm a cat person *and* a dog person, in that I like ~98% of the cats I've met but only about 10% of the dogs?[^18]
