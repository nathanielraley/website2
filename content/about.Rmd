...
<img height="200"  src="ndr_head.jpg" style="float: center;  margin-right: 1%; margin-bottom: 0.5em;">
<img height="200" src="jubes_on_beach.png" style="float: center; margin-right: 1%; margin-bottom: 0.5em;">
...
I am also very risk-averse, so I seldom go out anywhere unless compelled by strong arguments: the chances of my meeting an untimely end (or of having my time/money wasted!) go up dramatically when I leave hearth and home behind and go out among hordes of my fellow man,[^17] so I try my best not to. 
...
[^15]: sorry about all these weird animal-hobby metaphors...
...
[^17]: Candidates include old standards such as
 ...
 * Are there parallel universes in which all alternate possible histories and futures are real? ...Has everything that could
have possibly happened in our own past, but didn’t, actually occurred in the past of some other universe?"
...
devote one’s life to the cause?"...What if you realize that a future AI will realize that you will have realized this but failed
